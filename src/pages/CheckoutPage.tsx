            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-card rounded-xl border border-border p-6">
                ...
                {isLoadingMethods ? (
                  ...
                  <p className="text-muted-foreground">{t('checkout.noShippingFound')}</p>
                ) : (
                  <div className="space-y-3">
              ...
              <div className="bg-card rounded-xl border border-border p-6">
                ...
                {isLoadingPayments ? (
                  ...
                  <p className="text-muted-foreground">{t('checkout.noPaymentFound')}</p>
                ) : (
                  <div className="space-y-3">
                ...
                {hasPartial && formData.paymentMethodId && (
                  <div className="mt-4 p-4 border border-accent/30 bg-accent/5 rounded-lg">
                    <h3 className="font-semibold text-sm mb-2">{t('checkout.paymentDetails')}</h3>
              ...
              <div className="bg-card rounded-xl border border-border p-6 sticky top-24">
                ...
                {hasPartial && (
                  <div className="text-xs text-muted-foreground mb-4 space-y-1">
                    <div className="flex justify-between">
                      <span>{t('checkout.advancePayment')}:</span>
