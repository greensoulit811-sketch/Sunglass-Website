...
export default function ShopPage() {
  ...
  const FilterContent = () => (
    <div className="space-y-6">
      {/* Categories */}
      <div>
        <h3 className="font-bold text-sm uppercase tracking-wider mb-4 text-foreground">{t('common.categories')}</h3>
  ...
  return (
    <Layout>
      <div className="container-shop section-padding">
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-3xl md:text-4xl font-bold mb-1">{t('shop.title')}</h1>
          <p className="text-muted-foreground text-sm">
            {isLoading ? t('common.loading') : t('shop.productsFound').replace('{{count}}', filteredProducts.length.toString())}
          </p>
        </div>
          ...
          <div className="flex-1">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-16">
                <p className="text-muted-foreground text-lg">{t('shop.noProductsFound')}</p>
